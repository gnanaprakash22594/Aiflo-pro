        ...
        <section className="relative overflow-hidden bg-[#1a111e] py-24 text-white" id="method">
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="relative grid gap-12 md:grid-cols-4">
                    ...
                    {/* Traveling Node - Steady Linear Motion */}
                    <div className="absolute top-8 left-0 hidden w-full md:block pointer-events-none">
                        <div className="absolute top-0 left-0 w-3 h-3 rounded-full bg-white shadow-[0_0_20px_rgba(255,255,255,1)] animate-[travelNode_5s_linear_infinite] -translate-x-1/2 -translate-y-1/2"></div>
                    </div>
                    ...
                    <div className="relative flex flex-col items-center text-center group opacity-0 animate-[fadeInUp_0.6s_ease-out_0.6s] [animation-fill-mode:forwards]">
                        <div className="z-10 flex h-16 w-16 items-center justify-center rounded-full border-4 border-[#1a111e] bg-white text-xl font-black text-primary transition-all duration-300 group-hover:scale-110 animate-[badge1Glow_5s_linear_infinite]">
                            01
                        </div>
                    ...
                    <div className="relative flex flex-col items-center text-center group opacity-0 animate-[fadeInUp_0.6s_ease-out_0.9s] [animation-fill-mode:forwards]">
                        <div className="z-10 flex h-16 w-16 items-center justify-center rounded-full border-4 border-[#1a111e] bg-[#2a1d30] text-xl font-black text-white transition-all duration-300 group-hover:bg-primary group-hover:scale-110 animate-[badge2Glow_5s_linear_infinite]">
                            02
                        </div>
                    ...
                    <div className="relative flex flex-col items-center text-center group opacity-0 animate-[fadeInUp_0.6s_ease-out_1.2s] [animation-fill-mode:forwards]">
                        <div className="z-10 flex h-16 w-16 items-center justify-center rounded-full border-4 border-[#1a111e] bg-[#2a1d30] text-xl font-black text-white transition-all duration-300 group-hover:bg-accent-magenta group-hover:scale-110 animate-[badge3Glow_5s_linear_infinite]">
                            03
                        </div>
                    ...
                    <div className="relative flex flex-col items-center text-center group opacity-0 animate-[fadeInUp_0.6s_ease-out_1.5s] [animation-fill-mode:forwards]">
                        <div className="z-10 flex h-16 w-16 items-center justify-center rounded-full border-4 border-[#1a111e] bg-[#2a1d30] text-xl font-black text-white transition-all duration-300 group-hover:bg-accent-amber group-hover:scale-110 animate-[badge4Glow_5s_linear_infinite]">
                            04
                        </div>
